      ...
      const marker = L.marker([station.latitude, station.longitude], { icon: customIcon })
        ...
        .bindPopup(`
          <div style="font-family: sans-serif; min-width: 200px;">
            ...
            <a href="https://www.google.com/maps/dir/?api=1&destination=${station.latitude},${station.longitude}&destination_place_id=${encodeURIComponent(station.name + ', ' + station.address)}" 
               target="_blank" 
